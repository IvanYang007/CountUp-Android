...
// Curated Dark Palette (Moonlight on Ancient Bricks & Charcoal Washi: 月映青砖 · 五墨六彩)
val ZenDarkCanvas = Color(0xFF121411)        // Aged Kiln Slate / 幽玄深庭 (was #191B17)
val ZenDarkSurface = Color(0xFF232620)       // Damp Timber / 濡缘黑木 (was #252922)
val ZenDarkCard = Color(0xFF26231E)          // Default Charcoal Washi / 烟墨温宣 (was #24201A)
val ZenDarkTextPrimary = Color(0xFFF4EFE6)   // Moonlit Silk / 月下绢帛白 (was #F1EBDD, 12.8:1 AAA contrast)
val ZenDarkTextSecondary = Color(0xFFABA494) // Muted Tea Ink / 宿雨淡墨褐 (was #C4BEAE, 5.96:1 AA contrast)
val ZenDarkHairline = Color(0xFF3A3D35)      // Precision Parting Line / 铅白砖缝
val ZenDarkHairlineVariant = Color(0xFF454C3F)// Micro-divider highlight / 月映砖棱
