...
val KEYWORD_STYLE_RULES: List<Pair<List<String>, KeywordStyleMatch>> = listOf(
    ...
    listOf("tooth", "teeth", "dental", "dentist", "floss", "brush", "刷牙", "洗牙", "牙医", "拔牙", "补牙") to KeywordStyleMatch("tooth", "paper_indigo"),
    ...
    listOf("knife", "chop", "slice", "cutting", "切菜", "刀工", "配菜") to KeywordStyleMatch("knife", "paper_indigo"),
    listOf("laundry", "wash clothes", "washing machine", "linen", "洗衣服", "洗衣", "床单", "晾衣") to KeywordStyleMatch("washing_machine", "paper_indigo"),
    ...
    listOf("id card", "license", "pass", "certificate", "credential", "driver", "驾照", "身份证", "证件", "护照", "考证", "证书") to KeywordStyleMatch("identification_card", "paper_indigo"),
    ...
    listOf("mail", "letter", "envelope", "postcard", "信件", "写信", "寄信", "明信片", "邮件") to KeywordStyleMatch("envelope", "paper_indigo"),
    ...
    listOf("music", "piano", "song", "sing", "listening", "听歌", "音乐", "歌曲", "唱歌") to KeywordStyleMatch("music_note", "paper_indigo"),
